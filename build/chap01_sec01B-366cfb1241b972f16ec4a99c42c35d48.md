...
---
Venn Diagramm für den Schnitt $A\cap B$ (Quelle: eigene Darstellung;
...
name: fig01_union_DE
---
Venn Diagramm für die Vereinigung $A\cup B$ (Quelle: eigene Darstellung;
Lizenz [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/))
```
...
---
Venn Diagramm für die Differenz $A\setminus B$ (Quelle: eigene Darstellung;
Lizenz [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/))
```
...
---
Venn Diagramm für das Komplement $B^{C}=\bar{B}$ bzgl. $W$ (Quelle:
