...
width: 100%
---
Mehrere komplexe Zahlen in trigonometrischer Form (Quelle: eigene Darstellung; Lizenz [CC 
...
```{figure} pics/normal2polarform_light43.svg
---
width: 100%
---
Rechtwinkliges Dreieck zur Berechnung der Poloarform (Quelle: eigene Darstellung; Lizenz
...
$$\textcolor{red}{|z|} = \sqrt{(\sqrt{3})^2 + 1^2} = \sqrt{3 + 1} =
\textcolor{red}{2}.$$
...
$$\cos(\varphi) = \frac{\textcolor{blue}{\sqrt{3}}}{\textcolor{red}{2}}.$$
